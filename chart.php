...
class GFPersian_Chart_Alsat
{
	...
	public static function stats_page()
	{
		...
		if (!empty($_POST)) {
			check_admin_referer("search", "gf_alsat_chart");
		}

		$form_id = rgget("id");
		$form    = RGFormsModel::get_form_meta($form_id);
		if (empty($form) || !is_numeric($form_id) || intval($form_id) != $form_id) {
			die(__('فرم درخواستی وجود ندارد.', 'gravityformsalsat'));
		}
?>
		<style type="text/css">
			.alsat_graph_container {
				clear: both;
				padding-left: 5px;
				min-width: 789px;
				margin-right: 50px;
		...
		<?php wp_enqueue_script( 'jalali-datepicker_js', plugins_url( GFPersian_Payments::get_base_url() . '/assets/js/shamsi_chart.js', __FILE__ ), array(), $my_js_ver ); ?>
		<?php 
		...
		<div class="wrap">
			<ul class="subsubsub">
				<li><a class="<?php echo (!rgget("tab") || rgget("tab") == "today") ? "current" : "" ?>" href="?page=gf_alsat&view=stats&id=<?php echo rgget('id') ?>"><?php _e("امروز", "gravityformsalsat"); ?></a>
					|
				</li>
				<li><a class="<?php echo rgget("tab") == "yesterday" ? "current" : "" ?>" href="?page=gf_alsat&view=stats&id=<?php echo rgget('id') ?>&tab=yesterday"><?php _e("دیروز", "gravityformsalsat"); ?></a>
					|
				</li>
				<li><a class="<?php echo rgget("tab") == "last7days" ? "current" : "" ?>" href="?page=gf_alsat&view=stats&id=<?php echo rgget('id') ?>&tab=last7days"><?php _e("هفت روز گذشته", "gravityformsalsat"); ?></a>
					|
				</li>
				<li><a class="<?php echo rgget("tab") == "thisweek" ? "current" : "" ?>" href="?page=gf_alsat&view=stats&id=<?php echo rgget('id') ?>&tab=thisweek"><?php _e("هفته جاری", "gravityformsalsat"); ?></a>
					|
				</li>
				<li><a class="<?php echo rgget("tab") == "last30days" ? "current" : "" ?>" href="?page=gf_alsat&view=stats&id=<?php echo rgget('id') ?>&tab=last30days"><?php _e("30 روز گذشته", "gravityformsalsat"); ?></a>
					|
				</li>
				<li><a class="<?php echo rgget("tab") == "thismonth" ? "current" : "" ?>" href="?page=gf_alsat&view=stats&id=<?php echo rgget('id') ?>&tab=thismonth"><?php _e("ماه جاری", "gravityformsalsat"); ?></a>|
				</li>
				<li><a class="<?php echo rgget("tab") == "lastmonth" ? "current" : "" ?>" href="?page=gf_alsat&view=stats&id=<?php echo rgget('id') ?>&tab=lastmonth"><?php _e("ماه قبل", "gravityformsalsat"); ?></a>|
				</li>
				<li><a class="<?php echo rgget("tab") == "last2month" ? "current" : "" ?>" href="?page=gf_alsat&view=stats&id=<?php echo rgget('id') ?>&tab=last2month"><?php _e("2 ماه اخیر", "gravityformsalsat"); ?></a>
					|
				</li>
				<li><a class="<?php echo rgget("tab") == "last3month" ? "current" : "" ?>" href="?page=gf_alsat&view=stats&id=<?php echo rgget('id') ?>&tab=last3month"><?php _e("3 ماه اخیر", "gravityformsalsat"); ?></a>
					|
				</li>
				<li><a class="<?php echo rgget("tab") == "last6month" ? "current" : "" ?>" href="?page=gf_alsat&view=stats&id=<?php echo rgget('id') ?>&tab=last6month"><?php _e("6 ماه اخیر", "gravityformsalsat"); ?></a>
					|
				</li>
				<li><a class="<?php echo rgget("tab") == "last9month" ? "current" : "" ?>" href="?page=gf_alsat&view=stats&id=<?php echo rgget('id') ?>&tab=last9month"><?php _e("9 ماه اخیر", "gravityformsalsat"); ?></a>
					|
				</li>
				<li><a class="<?php echo rgget("tab") == "last12month" ? "current" : "" ?>" href="?page=gf_alsat&view=stats&id=<?php echo rgget('id') ?>&tab=last12month"><?php _e("یک سال اخیر", "gravityformsalsat"); ?></a>
					|
				</li>
				<li><a class="<?php echo rgget("tab") == "spring" ? "current" : "" ?>" href="?page=gf_alsat&view=stats&id=<?php echo rgget('id') ?>&tab=spring"><?php _e("بهار", "gravityformsalsat"); ?></a>|
				</li>
				<li><a class="<?php echo rgget("tab") == "summer" ? "current" : "" ?>" href="?page=gf_alsat&view=stats&id=<?php echo rgget('id') ?>&tab=summer"><?php _e("تابستان", "gravityformsalsat"); ?></a>|
				</li>
				<li><a class="<?php echo rgget("tab") == "fall" ? "current" : "" ?>" href="?page=gf_alsat&view=stats&id=<?php echo rgget('id') ?>&tab=fall"><?php _e("پاییز", "gravityformsalsat"); ?></a>|
				</li>
				<li><a class="<?php echo rgget("tab") == "winter" ? "current" : "" ?>" href="?page=gf_alsat&view=stats&id=<?php echo rgget('id') ?>&tab=winter"><?php _e("زمستان", "gravityformsalsat"); ?></a>|
				</li>
				<li><a class="<?php echo rgget("tab") == "thisyear" ? "current" : "" ?>" href="?page=gf_alsat&view=stats&id=<?php echo rgget('id') ?>&tab=thisyear"><?php _e("امسال", "gravityformsalsat"); ?></a>
				</li>
				<br /><br />
				<form method="post" action="?page=gf_alsat&view=stats&id=<?php echo rgget("id") ?>&tab=selection"><?php wp_nonce_field("search", "gf_alsat_chart") ?>
					<span><?php _e('از تاریخ', 'gravityformsalsat') ?></span>
					<input type="text" name="min" class="datepicker" value="<?php echo sanitize_text_field(rgpost('min')); ?>" autocomplete="off" />
					<span style="margin-right:15px"><?php _e('تا تاریخ', 'gravityformsalsat') ?></span>
					<input type="text" name="max" class="datepicker" value="<?php echo sanitize_text_field(rgpost('max')); ?>" autocomplete="off" />
					<input type="submit" class="button-primary button" name="submit" value="<?php _e('انتخاب', 'gravityformsalsat') ?>"><br>
				</form>
			</ul>
			...
			switch (rgget("tab")) {
				...
				case "spring":
					...
					$chart_info_alsat   = self::season_chart_info($form_id, 3, 1);
				...
				case "summer":
					...
					$chart_info_alsat   = self::season_chart_info($form_id, 3, 2);
				...
				case "fall":
					...
					$chart_info_alsat   = self::season_chart_info($form_id, 3, 3);
				...
				case "winter":
					...
					$chart_info_alsat   = self::season_chart_info($form_id, 3, 4);
				...
				case "thisyear":
					...
					$chart_info_alsat   = self::yearly_chart_info($form_id, 3);
				...
				case "last7days":
					...
					$chart_info_alsat   = self::lastxdays_chart_info($form_id, 3, 7);
				...
				case "thisweek":
					...
					$chart_info_alsat   = self::thisweek_chart_info($form_id, 3);
				...
				case "last30days":
					...
					$chart_info_alsat   = self::lastxdays_chart_info($form_id, 3, 30);
				...
				case "thismonth":
					...
					$chart_info_alsat   = self::targetmdays_chart_info($form_id, 3, 1);
				...
				case "lastmonth":
					...
					$chart_info_alsat   = self::targetmdays_chart_info($form_id, 3, 2);
				...
				case "last2month":
					...
					$chart_info_alsat   = self::targetmdays_chart_info($form_id, 3, 60);
				...
				case "last3month":
					...
					$chart_info_alsat   = self::targetmdays_chart_info($form_id, 3, 3);
				...
				case "last6month":
					...
					$chart_info_alsat   = self::targetmdays_chart_info($form_id, 3, 6);
				...
				case "last9month":
					...
					$chart_info_alsat   = self::targetmdays_chart_info($form_id, 3, 9);
				...
				case "last12month":
					...
					$chart_info_alsat   = self::targetmdays_chart_info($form_id, 3, 12);
				...
				case "selection":
					...
					$chart_info_alsat   = self::selection_chart_info($form_id, 3, sanitize_text_field(rgpost('min')), sanitize_text_field(rgpost('max')));
				...
				case "yesterday":
					...
					$chart_info_alsat   = self::tyday_chart_info($form_id, 3, 2);
				...
				default:
					...
					$chart_info_alsat   = self::tyday_chart_info($form_id, 3, 1);
			...
			<div class="clear"></div>
			<h2><?php _e(" درآمد از درگاه آلسات پرداخت برای فرمِ ", "gravityformsalsat") ?><?php echo '"' . $form["title"] . '"'; ?></h2>
			<div>
				<?php if (empty($chart_info["series"])) { ?>
					<div class="alsat_message_container"><?php _e("موردی یافت نشد . ", "gravityformsalsat") ?></div>
				<?php } else { ?>
					<div class="alsat_graph_container">
						<div id="graph_placeholder" style="width:100%;height:300px;"></div>
					</div>
				<?php
				}

				$sales_label = __("تعداد کل پرداخت های  آلسات پراخت این فرم", "gravityformsalsat");

				$transaction_totals = GFPersian_DB_alsat::get_transaction_totals($form_id);
				...
				?>
				<div class="alsat_summary_container">
					<div class="alsat_summary_item">
						<div class="alsat_summary_title"><?php _e('جمع پرداخت های  آلسات پرداخت این فرم', 'gravityformsalsat') ?></div>
						<div class="alsat_summary_value"><?php echo GF_tr_num(GFCommon::to_money($total_revenue), 'fa') ?></div>
					</div>

					<div class="alsat_summary_item">
						<div class="alsat_summary_title"><?php echo $chart_info["revenue_label"] ?></div>
						<div class="alsat_summary_value"><?php echo GF_tr_num($chart_info["revenue"], 'fa') ?></div>
					</div>

					<div class="alsat_summary_item">
						<div class="alsat_summary_title"><?php echo $chart_info["mid_label"] ?></div>
						<div class="alsat_summary_value"><?php echo GF_tr_num($chart_info["mid"], 'fa') ?></div>
					</div>

					<div class="alsat_summary_item">
						<div class="alsat_summary_title"><?php echo $sales_label ?></div>
						<div class="alsat_summary_value"><?php echo GF_tr_num($total_sales, 'fa') ?></div>
					</div>

					<div class="alsat_summary_item">
						<div class="alsat_summary_title"><?php echo $chart_info["sales_label"] ?></div>
						<div class="alsat_summary_value"><?php echo GF_tr_num($chart_info["sales"], 'fa') ?></div>
					</div>

					<div class="alsat_summary_item">
						<div class="alsat_summary_title"><?php echo $chart_info["midt_label"] ?></div>
						<div class="alsat_summary_value"><?php echo GF_tr_num($chart_info["midt"], 'fa') ?></div>
					</div>
			...
			<hr>
			<div class="clear"></div>
			<h2><?php _e(" درآمد از همه روشها برای فرمِ ", "gravityformsalsat") ?><?php echo '"' . $form["title"] . '"'; ?></h2>
			<div>
				...
				$sales_label = __("تعداد کل پرداخت های  همه روشهای این فرم", "gravityformsalsat");

				$transaction_totals = GFPersian_DB_alsat::get_transaction_totals_gateways($form_id);
				$total_sales        = empty($transaction_totals["active"]["transactions"]) ? 0 : $transaction_totals["active"]["transactions"];
				$total_revenue      = empty($transaction_totals["active"]["revenue"]) ? 0 : $transaction_totals["active"]["revenue"];
				?>
				...
				<div class="alsat_summary_container">
					...
					<div class="alsat_summary_item">
						<div class="alsat_summary_title"><?php _e("جمع پرداخت های  همه روشهای این فرم", "gravityformsalsat") ?></div>
						<div class="alsat_summary_value"><?php echo GF_tr_num(GFCommon::to_money($total_revenue), 'fa') ?></div>
					</div>

					<div class="alsat_summary_item">
						<div class="alsat_summary_title"><?php echo $chart_info_gateways["revenue_label"] ?></div>
						<div class="alsat_summary_value"><?php echo GF_tr_num($chart_info_gateways["revenue"], 'fa') ?></div>
					</div>

					<div class="alsat_summary_item">
						<div class="alsat_summary_title"><?php echo $chart_info_gateways["mid_label"] ?></div>
						<div class="alsat_summary_value"><?php echo GF_tr_num($chart_info_gateways["mid"], 'fa') ?></div>
					</div>
					...
					<div class="alsat_summary_item">
						<div class="alsat_summary_title"><?php echo $chart_info_gateways["sales_label"] ?></div>
						<div class="alsat_summary_value"><?php echo GF_tr_num($chart_info_gateways["sales"], 'fa') ?></div>
					</div>

					<div class="alsat_summary_item">
						<div class="alsat_summary_title"><?php echo $chart_info_gateways["midt_label"] ?></div>
						<div class="alsat_summary_value"><?php echo GF_tr_num($chart_info_gateways["midt"], 'fa') ?></div>
					</div>
			...
			<hr>
			<div class="clear"></div>
			<h2><?php _e(" کل درآمد های آلسات پرداخت", "gravityformsalsat") ?></h2>
			<div>
				<?php if (!$chart_info_alsat["series"]) { ?>
					<div class="alsat_message_container"><?php _e("موردی یافت نشد . ", "gravityformsalsat") ?></div>
				<?php } else { ?>
					<div class="alsat_graph_container">
				...
				$sales_label = __("تعداد کل پرداخت های درگاه آلسات پرداخت", "gravityformsalsat");

				$transaction_totals = GFPersian_DB_alsat::get_transaction_totals_this_gateway();
				$total_sales        = empty($transaction_totals["active"]["transactions"]) ? 0 : $transaction_totals["active"]["transactions"];
				$total_revenue      = empty($transaction_totals["active"]["revenue"]) ? 0 : $transaction_totals["active"]["revenue"];
				?>
				<div class="alsat_summary_container">
					<div class="alsat_summary_item">
						<div class="alsat_summary_title"><?php _e("جمع پرداخت های  همه فرمهای آلسات پرداخت", "gravityformsalsat") ?></div>
						<div class="alsat_summary_value"><?php echo GF_tr_num(GFCommon::to_money($total_revenue), 'fa') ?></div>
					</div>

					<div class="alsat_summary_item">
						<div class="alsat_summary_title"><?php echo $chart_info_alsat["revenue_label"] ?></div>
						<div class="alsat_summary_value"><?php echo GF_tr_num($chart_info_alsat["revenue"], 'fa') ?></div>
					</div>

					<div class="alsat_summary_item">
						<div class="alsat_summary_title"><?php echo $chart_info_alsat["mid_label"] ?></div>
						<div class="alsat_summary_value"><?php echo GF_tr_num($chart_info_alsat["mid"], 'fa') ?></div>
					</div>
					...
					<div class="alsat_summary_item">
						<div class="alsat_summary_title"><?php echo $chart_info_alsat["sales_label"] ?></div>
						<div class="alsat_summary_value"><?php echo GF_tr_num($chart_info_alsat["sales"], 'fa') ?></div>
					</div>

					<div class="alsat_summary_item">
						<div class="alsat_summary_title"><?php echo $chart_info_alsat["midt_label"] ?></div>
						<div class="alsat_summary_value"><?php echo GF_tr_num($chart_info_alsat["midt"], 'fa') ?></div>
					</div>
				</div>
			</div>
			<hr>
			<div class="clear"></div>
			<h2><?php _e(" کل درآمد های سایت ( همه روشها برای همه فرم ها)", "gravityformsalsat") ?></h2>
			<div>
				...
				$sales_label = __("تعداد کل پرداخت های همه فرمهای سایت", "gravityformsalsat");

				$transaction_totals = GFPersian_DB_alsat::get_transaction_totals_site();
				$total_sales        = empty($transaction_totals["active"]["transactions"]) ? 0 : $transaction_totals["active"]["transactions"];
				$total_revenue      = empty($transaction_totals["active"]["revenue"]) ? 0 : $transaction_totals["active"]["revenue"];
				?>
				<div class="alsat_summary_container">
					<div class="alsat_summary_item">
						<div class="alsat_summary_title"><?php _e("جمع کل پرداخت های همه فرمهای سایت", "gravityformsalsat") ?></div>
						<div class="alsat_summary_value"><?php echo GF_tr_num(GFCommon::to_money($total_revenue), 'fa') ?></div>
					</div>

					<div class="alsat_summary_item">
						<div class="alsat_summary_title"><?php echo $chart_info_site["revenue_label"] ?></div>
						<div class="alsat_summary_value"><?php echo GF_tr_num($chart_info_site["revenue"], 'fa') ?></div>
					</div>

					<div class="alsat_summary_item">
						<div class="alsat_summary_title"><?php echo $chart_info_site["mid_label"] ?></div>
						<div class="alsat_summary_value"><?php echo GF_tr_num($chart_info_site["mid"], 'fa') ?></div>
					</div>
					<div class="alsat_summary_item">
						<div class="alsat_summary_title"><?php echo $sales_label ?></div>
						<div class="alsat_summary_value"><?php echo GF_tr_num($total_sales, 'fa') ?></div>
					...
					<div class="alsat_summary_item">
						<div class="alsat_summary_title"><?php echo $chart_info_site["sales_label"] ?></div>
						<div class="alsat_summary_value"><?php echo GF_tr_num($chart_info_site["sales"], 'fa') ?></div>
					</div>

					<div class="alsat_summary_item">
						<div class="alsat_summary_title"><?php echo $chart_info_site["midt_label"] ?></div>
						<div class="alsat_summary_value"><?php echo GF_tr_num($chart_info_site["midt"], 'fa') ?></div>
					</div>
				</div>
			</div>
		</div>
		...
		<script type="text/javascript">
			function startShowTooltip(item, graph) {
				if (item) {
					if (!previousPoint || previousPoint[0] != item.datapoint[0]) {
						...
						jQuery("#alsat_graph_tooltip").remove();
			...
			<?php if (!empty($chart_info["series"])) : ?>
				var alsat_graph_tooltips = <?php echo GF_tr_num($chart_info["tooltips"], 'fa') ?>;
				...
				jQuery("#graph_placeholder").bind("plothover", function(event, pos, item) {
					startShowTooltip(item, alsat_graph_tooltips);
				});
			<?php endif; ?>


			<?php if (!empty($chart_info_alsat["series"])) : ?>
				var alsat_graph_tooltip1s1 = <?php echo GF_tr_num($chart_info_alsat["tooltips"], 'fa') ?>;
				jQuery.plot(jQuery("#graph_placeholder1"), [<?php echo $chart_info_alsat["series"] ?>], <?php echo $chart_info["options"] ?>);
				jQuery(window).resize(function() {
					jQuery.plot(jQuery("#graph_placeholder1"), [<?php echo $chart_info_alsat["series"] ?>], <?php echo $chart_info["options"] ?>);
				});
				var previousPoint = null;
				jQuery("#graph_placeholder1").bind("plothover", function(event, pos, item) {
					startShowTooltip(item, alsat_graph_tooltip1s1);
				});
			<?php endif; ?>


			<?php if (!empty($chart_info_gateways["series"])) : ?>
				var alsat_graph_tooltip2s2 = <?php echo GF_tr_num($chart_info_gateways["tooltips"], 'fa') ?>;
				...
				jQuery("#graph_placeholder2").bind("plothover", function(event, pos, item) {
					startShowTooltip(item, alsat_graph_tooltip2s2);
				});
			<?php endif; ?>


			<?php if (!empty($chart_info_site["series"])) : ?>
				var alsat_graph_tooltip3s3 = <?php echo GF_tr_num($chart_info_site["tooltips"], 'fa') ?>;
				...
				jQuery("#graph_placeholder3").bind("plothover", function(event, pos, item) {
					startShowTooltip(item, alsat_graph_tooltip3s3);
				});
			<?php endif; ?>

			function showTooltip(x, y, contents) {
				jQuery('<div id="alsat_graph_tooltip">' + contents + '<div class="tooltip_tip1"></div></div>').css({
					position: 'absolute',
					display: 'none',
					opacity: 1,
					width: '150px',
...
<?php
	...
	public static function lastxdays_chart_info($form_id, $chart, $x)
	{
		...
		if ($chart == 1) {
			...
			$t       = __('آلسات پرداخت این فرم', 'gravityformsalsat');
			$results = $wpdb->get_results("SELECT CONVERT_TZ(l.payment_date, '+00:00', '{$tz_offset}') as date, sum(l.payment_amount) as amount_sold, count(l.id) as new_sales
                                        FROM " . GFPersian_DB_alsat::get_entry_table_name() . " l
                                        WHERE form_id={$form_id} AND l.status='active' AND l.is_fulfilled=1 AND l.payment_method='alsat'
                                        GROUP BY date(date)
		...
		if ($chart == 2) {
			...
			$t       = __('همه روشهای این فرم', 'gravityformsalsat');
			$results = $wpdb->get_results("SELECT CONVERT_TZ(l.payment_date, '+00:00', '{$tz_offset}') as date, sum(l.payment_amount) as amount_sold, count(l.id) as new_sales
                                        FROM " . GFPersian_DB_alsat::get_entry_table_name() . " l
		...
		if ($chart == 3) {
			$c       = 'orang';
			$dt      = "}";
			$t       = __("همه فرمهای آلسات پرداخت", 'gravityformsalsat');
			$results = $wpdb->get_results("SELECT CONVERT_TZ(l.payment_date, '+00:00', '{$tz_offset}') as date, sum(l.payment_amount) as amount_sold, count(l.id) as new_sales
                                        FROM " . GFPersian_DB_alsat::get_entry_table_name() . " l
                                        WHERE l.status='active' AND l.is_fulfilled=1 AND l.payment_method='alsat'
                                        GROUP BY date(date)
                                        ORDER BY payment_date desc");
		}
		...
		if ($chart == 4) {
			...
			$t       = __("همه فرمهای سایت", 'gravityformsalsat');
			$results = $wpdb->get_results("SELECT CONVERT_TZ(l.payment_date, '+00:00', '{$tz_offset}') as date, sum(l.payment_amount) as amount_sold, count(l.id) as new_sales
                                        FROM " . GFPersian_DB_alsat::get_entry_table_name() . " l
		...
		if (!empty($results)) {
			...
			foreach ($results as $result) {
				...
				$sales_line = "<div class='alsat_tooltip_sales'><span class='alsat_tooltip_heading'>" . __("تعداد پرداخت ", "gravityformsalsat") . ": </span><span class='alsat_tooltip_value'>" . $result->new_sales . "</span></div>";

				$tooltips .= "\"<div class='tooltipbox_" . $c . "'><div class='alsat_tooltip_date'>" . $timeX_tooltips . "</div>{$sales_line}<div class='alsat_tooltip_revenue'><span class='alsat_tooltip_heading'>" . __("پرداختی", "gravityformsalsat") . ": </span><span class='alsat_tooltip_value'>" . GFCommon::to_money($result->amount_sold) . "</span></div></div>\",";
			}
		...
		if ($x == 7) {
			$n   = __('7 روز', 'gravityformsalsat');
			$mid = 7;
		}
		if ($x == 30) {
			$n   = __('30 روز', 'gravityformsalsat');
			$mid = 30;
		}

		$sales_label = sprintf(__("تعداد پرداخت های %s گذشته %s", 'gravityformsalsat'), $n, $t);

		$midt          = $mid ? $sales_week / $mid : 0;
		$mid           = ($mid ? GFCommon::to_money($revenue_week / $mid) : 0) . __(" در روز", 'gravityformsalsat');
		$midt          = number_format($midt, 3, '.', '') . __(" در روز", 'gravityformsalsat');
		$midt_label    = sprintf(__("میانگین تعداد پرداخت های %s گذشته %s", 'gravityformsalsat'), $n, $t);
		$mid_label     = sprintf(__("میانگین پرداخت های %s گذشته %s", 'gravityformsalsat'), $n, $t);
		$revenue_week  = GFCommon::to_money($revenue_week);
		$revenue_label = sprintf(__("جمع پرداخت های %s گذشته %s", 'gravityformsalsat'), $n, $t);
	...
	public static function thisweek_chart_info($form_id, $chart)
	{
		...
		if ($chart == 4) {
			$c       = 'red';
			$dt      = "points: { symbol: 'triangle', fillColor: '#AA4643' }, color: '#AA4643'}";
			$t       = __("همه فرم های سایت", 'gravityformsalsat');
			$results = $wpdb->get_results("SELECT CONVERT_TZ(l.payment_date, '+00:00', '{$tz_offset}') as date, sum(l.payment_amount) as amount_sold, count(l.id) as new_sales
                                        FROM " . GFPersian_DB_alsat::get_entry_table_name() . " l
                                        WHERE l.status='active' AND l.is_fulfilled=1
                                        GROUP BY date(date)
		...
		$sales_label = __("تعداد پرداخت های  این هفته ", 'gravityformsalsat') . $t;

		$midt          = $sales_week / 7;
		$midt          = ($midt ? number_format($midt, 3, '.', '') : 0) . __(" در روز", 'gravityformsalsat');
		$midt_label    = __("میانگین تعداد پرداخت های  این هفته ", 'gravityformsalsat') . $t;
		$mid           = GFCommon::to_money($revenue_week / 7) . __(" در روز", 'gravityformsalsat');
		$mid_label     = __("میانگین پرداخت های این هفته ", 'gravityformsalsat') . $t;
		$revenue_week  = GFCommon::to_money($revenue_week);
		$revenue_label = __("جمع پرداخت های  این هفته ", 'gravityformsalsat') . $t;
	...
	public static function targetmdays_chart_info($form_id, $chart, $xmonth)
	{
		...
		if (!empty($results)) {
			...
			if ($xmonth == 60 || $xmonth == 3 || $xmonth == 6 || $xmonth == 9 || $xmonth == 12) {
				...
				$n = $n . __(" ماه اخیر", "gravityformsalsat");

				if ($xmonth == 12) {
					$n = __(" یکسال اخیر", "gravityformsalsat");
				}
			}
		...
		if ($xmonth == 60 || $xmonth == 3 || $xmonth == 6 || $xmonth == 9 || $xmonth == 12) {
			...
			if ($xmonth == 12) {
				$n = __('یک سال اخیر', 'gravityformsalsat');
			}
		}

		$sales_label = __('تعداد پرداخت های  ', 'gravityformsalsat') . $n . ' ' . $t;
		...
		$midt             = number_format($midt, 3, '.', '') . __(" در روز", 'gravityformsalsat');
		$midt_label       = __('میانگین تعداد پرداخت های ', 'gravityformsalsat') . $n . ' ' . $t;
		$mid              = ($midd ? GFCommon::to_money($revenue_thistday / $midd) : 0) . __(" در روز", 'gravityformsalsat');
		$mid_label        = __('میانگین پرداخت های ', 'gravityformsalsat') . $n . ' ' . $t;
		$revenue_label    = __('جمع پرداخت های  ', 'gravityformsalsat') . $n . ' ' . $t;
	...
	public static function tyday_chart_info($form_id, $chart, $day)
	{
		...
		$date          = new DateTime($today);
		if ($day == 1) {
			$n    = __("امروز", 'gravityformsalsat');
			$baze = date('m d , Y', $tday);
			$ty   = date('Ymd', $tday);
		} else if ($day == 2) {
			$n = __("دیروز", 'gravityformsalsat');
			$date->sub(new DateInterval('P1DT0H0M'));
		...
		$midt          = $sales_today / 24;
		$midt          = number_format($midt, 3, '.', '') . __(" در ساعت", "gravityformsalsat");
		$midt_label    = __("میانگین تعداد پرداخت های ", "gravityformsalsat") . $n . " " . $t;
		$mid           = GFCommon::to_money($revenue_today / 24) . __(" در ساعت", "gravityformsalsat");
		$mid_label     = __("میانگین پرداخت های ", "gravityformsalsat") . $n . " " . $t;
	...
	public static function yearly_chart_info($form_id, $chart)
	{
		...
		$sales_label = __("تعداد پرداخت های امسال ", "gravityformsalsat") . $t;
		...
		$midt           = number_format($midt, 3, '.', '') . __(" در روز", "gravityformsalsat");
		$midt_label     = __("میانگین تعداد پرداخت های امسال ", "gravityformsalsat") . $t;
		$mid            = ($midd ? GFCommon::to_money($revenue_yearly / $midd) : 0) . __(" در روز", "gravityformsalsat");
		$mid_label      = __("میانگین پرداخت های امسال ", "gravityformsalsat") . $t;
		$revenue_yearly = GFCommon::to_money($revenue_yearly);
		$revenue_label  = __("جمع پرداخت های امسال ", "gravityformsalsat") . $t;
	...
	public static function season_chart_info($form_id, $chart, $season)
	{
		...
		if ($season == 2) {
			$n      = __('تابستان', 'gravityformsalsat');
			$ebtda  = $avalesal_t;
		...
		$midt           = ($midt ? number_format($midt, 3, '.', '') : 0) . __(" در روز", 'gravityformsalsat');
		$midt_label     = __("میانگین تعداد پرداخت های  ", 'gravityformsalsat') . $n . " " . $t;
		$mid            = ($midd ? GFCommon::to_money($revenue_season / $midd) : 0) . __(" در روز", 'gravityformsalsat');
		$mid_label      = __("میانگین پرداخت های  ", 'gravityformsalsat') . $n . " " . $t;
		$revenue_label  = __("جمع پرداخت های  ", 'gravityformsalsat') . $n . " " . $t;
	...
	public static function selection_chart_info($form_id, $chart, $min, $max)
	{
		...
		$sales_label = __("تعداد پرداخت های بازه انتخابی ", 'gravityformsalsat') . $t;

		$midt          = $midd ? $sales_today / $midd : 0;
		$midt          = number_format($midt, 3, '.', '') . __(" در روز", 'gravityformsalsat');
		$midt_label    = __("میانگین تعداد پرداخت های  ", 'gravityformsalsat') . $t . "";
		$mid           = ($midd ? GFCommon::to_money($revenue_today / $midd) : 0) . __(" در روز", 'gravityformsalsat');
		$mid_label     = __("میانگین پرداخت های  ", 'gravityformsalsat') . $t . "";
		$revenue_today = GFCommon::to_money($revenue_today);
		$revenue_label = __("جمع پرداخت های بازه انتخابی ", 'gravityformsalsat') . $t;
